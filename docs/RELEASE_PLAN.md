...
| **1.0.0** | `v1.0.0` | `dev` @ brief-complete | T0–T6: EDA, RAG, MCP, dual-lane, `/chat`, README | B1–B9 DONE, G2–G6, 19 tests, CI quality job green | **MERGE NOW** |
| **1.1.0** | `v1.1.0` | future `dev` | G1 load test artifact, `/chat/stream`, golden fixtures | p95 topic guard documented; streaming tests | Planned |
